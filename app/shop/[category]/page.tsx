  ...
  if (!category) {
    return (
      <div className="container py-20 text-center bg-[#FBF6EC]">
        <h1 className="font-serif text-2xl font-bold text-[#132A3A]">Category Not Found</h1>
        <p className="font-mono text-xs text-[#1C1A17]/60 mt-2">The specified category could not be found.</p>
  ...
  return (
    ...
    >
      <div className="container">
        ...
        <div className="bg-white border-2 border-[#E7DCC4] p-6 rounded-[3px] shadow-sm mb-8">
          ...
          <h1 className="font-serif text-3xl md:text-4xl font-extrabold text-[#132A3A] mb-2">
            {category.name}
          </h1>
          <p className="text-xs sm:text-sm text-[#1C1A17]/70 font-sans">{category.description}</p>
        </div>
        ...
        {result && result.totalPages > 1 && (
          <div className="flex justify-center items-center gap-3 mt-10 font-mono text-xs">
            <button
              ...
              disabled={page === 1}
              className="px-4 py-2 border border-[#E7DCC4] bg-white rounded-[3px] font-bold text-[#132A3A] disabled:opacity-40"
            >
              PREVIOUS
            </button>
            <span className="font-bold text-[#132A3A]">
